...
def encrypt(plaintext, inner_txt, key):
    ...
    for i in range(0, len(plaintext), block_size):
        ...
        # print("block: ", block)
        # print("plaintext: ", plaintext[i:i + block_size])
        cipher_block = xor_bytes(block, key_hash)
        # print("cipher_block: ", cipher_block)
...
def pad(data, block_size):
    ...
    # print("pad: ", len(data) % block_size)
    # print("padding_length: ", padding_length)
    # print("block_size: ", block_size)
    # print("data: ", data)
    # print("len(data): ", len(data))
    # print("padding: ", bytes([padding_length] * padding_length))
    # print("data.encode(): ", data.encode()+padding)
    # print("len: ", len(data.encode() + padding))
...
def xor_bytes(a, b):
    ...
    # print("bytes: ", bytes(x ^ y for x, y in zip(a, b)))
